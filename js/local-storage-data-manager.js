// Simple LocalStorage Data Manager
...
class LocalStorageDataManager {
    ...
    async init() {
        try {
            ...
            console.log('LocalStorage Data Manager initialized');
        } catch (error) {
            console.error('Failed to initialize LocalStorage Data Manager:', error);
            throw error;
        }
    }
    ...
    ensureInitialized() {
        if (!this.isInitialized) {
            throw new Error('LocalStorage Data Manager not initialized');
        }
    }
...
window.LocalStorageDataManager = LocalStorageDataManager;
