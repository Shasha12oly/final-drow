// Google Sheets Analytics System for Growth Tracker
// Replaces database analytics with Google Sheets-based analytics
...
class GoogleSheetsAnalytics {
    ...
    isValidDay(record) {
        const requiredHabits = ['Physics', 'AdditionalSubjectChemistryMaths', 'Exercise', 'WakeUp', 'ScreenControl'];
